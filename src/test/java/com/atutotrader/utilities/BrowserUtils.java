package com.atutotrader.utilities;
...
public class BrowserUtils {
    ...
    public static void waitForPageToLoad(long timeOutInSeconds) {
        ...
        try {
            WebDriverWait wait = new WebDriverWait(MyDriver.get(), timeOutInSeconds);
    ...
    public static String getScreenshot(String name) {
        ...
        TakesScreenshot takesScreenshot = (TakesScreenshot) MyDriver.get();
